    ...
    public class WorkerUpgrade : Upgrade
    {
        ...
        private void Start()
        {
            ...
            for (int i = 0; i < CurrentLevel; i++)
            {
                ...
                Worker worker = _factoryWorker.CreateWorker(position, _spawnPoint.rotation);
        ...
        public override void ApplyUpgrade()
        {
            ...
            {
                base.ApplyUpgrade();
                Worker worker = _factoryWorker.CreateWorker(_spawnPoint.position, _spawnPoint.rotation);
