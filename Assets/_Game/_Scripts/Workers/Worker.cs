...
namespace CityBuilder.Workers
{
    public class Worker : RestartEntity
    {
        ...
        public void Init(StateMachine.StateMachine stateMachine, SpeedUpgrade speedUpgrade, IncomeUpgrade incomeUpgrade,
            Transform[] targets, [CanBeNull] Transform[] pathPointsA, Transform[] pathPointsB,
            BuildingController buildingController, Wallet.Wallet wallet)
        {
        ...
        public void SwitchTarget()
        {
            ...
            _target = _currentPath % 2 == 0
                ? _pathPointsA[Random.Range(0, _pathPointsA.Length)]
                : _pathPointsB[Random.Range(0, _pathPointsB.Length)];
        }
